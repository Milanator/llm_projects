...
Include details of company culture, customers and careers/jobs if you have the information. This content will be in English. "

def get_user_prompt(company_name, details) -> str:
...
def get_stream(company_name: str, details: str) -> str:
    stream = api_call([
        ...
        {"role": "user", "content": get_user_prompt(company_name, details)}
    ], False, True)
